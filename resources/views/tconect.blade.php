                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    @if(isset($first_post))
                        <div class="post-thumb">
                            <img src="{{$first_post->featured}}" alt="{{$first_post->title}}" height="278px">
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="15_blog_details.html">The Important cool Standard Post Format</a>
                                    </h2>
            ...
            <div class="row">
                <div class="subscribe scrollme">
                    <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                        <h4 class="subscribe-title">Feedback</h4>
                        <form class="subscribe-form" method="post" action="">
                            <input class="email input-standard-grey input-white" name="email" required="required" placeholder="Your Feeback" type="email">
                            <button class="subscr-btn">submit
                                <span class="semicircle--right"></span>
                            </button>
                        </form>
                        <div class="sub-title">Your Feedback will help us to improve our services</div>
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >tconect</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">a new way to social
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">dhirajkahar7@gmail.com</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">Kandivali, Mumbai</a>
                            <p class="sub-title">Thakur college</p>
                        </div>
                    </div>
                </div>
            </div>
